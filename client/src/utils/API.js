...
import axios from "axios";
 export default {
    ...
    searchTrailer: function(title, res){ 
        ...
        return axios.get("https://www.googleapis.com/youtube/v3/search?key=AIzaSyDDj_AcWjGNwn1eXlP4bavbvWzlgj6G5Q8&part=snippet&q=" + title + " game trailer&maxResults=1")
